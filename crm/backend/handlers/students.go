...
var (
	...
	memStudents = []models.Student{
		...
		{
			ID: "seed-2", TenantID: "BGC-METRO",
			FirstName: "Alise", LastName: "Dixon",
			Email: "adixon@bgcsm.org", Phone: "(313) 555-0002",
			AgeGrade: "Parent/Guardian", EducationLevel: "Some College",
			ProgramInterest: []string{"Advanced Manufacturing"},
			ExperienceLevel: "Some exposure", Language: "English",
			HearAboutUs: "Boys & Girls Club Event", Goals: "Support student learning pathways.",
			Cohort: "Spring 2026", EnrollmentDate: time.Now(), Status: "Active",
		},
	}
)
