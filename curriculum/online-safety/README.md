...
**Consultants:** @AppleEcosystemEngineer

## Overview
This curriculum is designed to empower youth to navigate the internet responsibly using Apple technology.

## Modules
1. [**Digital Footprint & Reputation**](./module-1-footprint.md): Understanding your digital trace.
2. [**Apple Safety Features**](./module-2-safety-features.md): Mastery of Screen Time and Family Sharing.
